...
const I18n = (() => {
    ...
    const translations = {
        en: {
            ...
            'ui.currentConditions': 'Current Conditions',
            'ui.asOf': 'As of',
            'ui.feelsLike': 'Feels like',
            'ui.humidity': 'Humidity',
            'ui.wind': 'Wind',
            'ui.precipitation': 'Precipitation',
            ...
            'ui.ecccAlmanacTitle': 'ECCC Almanac (Daily)',
            'ui.avgHigh': 'Average High',
            'ui.avgLow': 'Average Low',
            'ui.recordHigh': 'Record High',
            'ui.recordLow': 'Record Low',
               'ui.rollingWindowActual': 'Last {0} days (actual)',
               'ui.rollingWindowBaseline': '10-year {0}-day average',
               'ui.todayVsDaily': 'Today vs 10-year daily average',
               'ui.prevMonthVsBaseline': '{0} vs 10-year average',
               'ui.monthThisYear': 'This year (month)',
               'ui.baselineLabel': '10-year baseline',
               'ui.recordsLabel': 'Records',
               'ui.dataSourceArchive': 'Data: Open-Meteo Archive API',
               'ui.noRecentData': 'No recent data',
               'ui.atAverage': 'At 10-year average',
               'ui.deltaWarmer': '▲ {0}° warmer',
               'ui.deltaCooler': '▼ {0}° cooler',
            'ui.sourceECCC': 'Source: Environment Canada Almanac',
            'ui.ecccHistoricalLink': 'ECCC Historical Data (Today)',
            'ui.ecccAlmanacLink': 'ECCC Almanac (Today)',
            'ui.gdacsTitle': 'Global Disasters (GDACS)',
            'ui.gdacsSource': 'Source: GDACS RSS (last 7 days)',
        ...
        fr: {
            ...
            'ui.currentConditions': 'Conditions actuelles',
            'ui.asOf': 'Au',
            'ui.feelsLike': 'Ressenti',
            'ui.humidity': 'Humidité',
            'ui.wind': 'Vent',
            'ui.precipitation': 'Précipitations',
            ...
            'ui.ecccAlmanacTitle': 'Almanach ECCC (quotidien)',
            'ui.avgHigh': 'Moyenne maximale',
            'ui.avgLow': 'Moyenne minimale',
            'ui.recordHigh': 'Record maximal',
            'ui.recordLow': 'Record minimal',
               'ui.rollingWindowActual': 'Derniers {0} jours (données réelles)',
               'ui.rollingWindowBaseline': 'Moyenne sur {0} jours (10 ans)',
               'ui.todayVsDaily': "Aujourd'hui vs moyenne quotidienne (10 ans)",
               'ui.prevMonthVsBaseline': '{0} vs moyenne sur 10 ans',
               'ui.monthThisYear': 'Ce mois-ci (année en cours)',
               'ui.baselineLabel': 'Référence sur 10 ans',
               'ui.recordsLabel': 'Records',
               'ui.dataSourceArchive': 'Données : API Open-Meteo Archive',
               'ui.noRecentData': 'Aucune donnée récente',
               'ui.atAverage': 'À la moyenne sur 10 ans',
               'ui.deltaWarmer': '▲ {0}° plus chaud',
               'ui.deltaCooler': '▼ {0}° plus froid',
            'ui.sourceECCC': "Source : Almanach d'Environnement Canada",
            'ui.ecccHistoricalLink': "Données historiques ECCC (Aujourd'hui)",
            'ui.ecccAlmanacLink': "Almanach ECCC (Aujourd'hui)",
            'ui.gdacsTitle': 'Catastrophes mondiales (GDACS)',
            'ui.gdacsSource': 'Source : RSS GDACS (7 derniers jours)',
